...
# spherical wood shape.
# experimental data taken from Figure 1 (sphere) in Sadhukhan2009
...
Tcyl = np.loadtxt('Fig1_Tsphere.csv', delimiter=',')
mcyl = np.loadtxt('Fig1_Msphere.csv', delimiter=',')
