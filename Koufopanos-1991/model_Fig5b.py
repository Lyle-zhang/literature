"""
Compare 1-D transient heat conduction model to Koufopanos1991 Figure 5b
"""
...
t1, phi = np.loadtxt('Fig5b_phi.csv', delimiter=',', unpack=True)
t2, weight = np.loadtxt('Fig5b_weight.csv', delimiter=',', unpack=True)
temp = phi*(Ti-Tinf)+Tinf   # convert dimensionless phi to Kelvin

# plot model vs experiment data
py.close('all')
