"""
Compare 1-D transient heat conduction model to Figure 11 in Pyle 1984
"""
...
h = 35          # heat transfer coefficient, W/m^2*K
...
t1, Temp = np.loadtxt('Fig11Tcenter.csv', delimiter=',', unpack=True)
t2, Mass = np.loadtxt('Fig11conv.csv', delimiter=',', unpack=True)
