"""
Compare 1-D transient heat conduction model to Figure 9 in Pyle 1984
"""
...
t1, Temp = np.loadtxt('Fig9Tcenter.csv', delimiter=',', unpack=True)
t2, Mass = np.loadtxt('Fig9conv.csv', delimiter=',', unpack=True)
