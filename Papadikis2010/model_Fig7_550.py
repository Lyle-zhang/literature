"""
Compare 1-D transient heat conduction model to Papadikis2010a for d = 550um
"""
...
d = 0.055e-2    # biomass particle diameter, m
...
tc550, Tc550 = np.loadtxt('Fig7_cent550.csv', delimiter=',', unpack=True)
ts550, Ts550 = np.loadtxt('Fig7_surf550.csv', delimiter=',', unpack=True)
...
py.plot(tc550-1, Tc550, 'ob', label='center')
py.plot(ts550-1, Ts550, 'or', label='surface')
