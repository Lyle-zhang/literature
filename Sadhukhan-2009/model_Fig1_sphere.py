"""
Compare 1-D transient heat conduction model to Sadhukhan 2009 Figure 1 sphere
"""
...
t1, Tsph = np.loadtxt('Fig1_Tsphere.csv', delimiter=',', unpack=True)
t2, Msph = np.loadtxt('Fig1_Msphere.csv', delimiter=',', unpack=True)
...
py.plot(t1, Tsph+273, 'og', label='axis')
...
py.plot(t2, Msph, 'og', label='weight')
py.ylim([0, 1.1])
py.legend(loc='best', numpoints=1)
py.xlabel('Time (s)')
