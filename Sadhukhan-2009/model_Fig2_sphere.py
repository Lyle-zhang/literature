"""
Compare 1-D transient heat conduction model to Sadhukhan 2009 Figure 2 sphere
"""
...
t1, Tsph = np.loadtxt('Fig2_Tsphere.csv', delimiter=',', unpack=True)
t2, Msph = np.loadtxt('Fig2_Msphere.csv', delimiter=',', unpack=True)
...
py.plot(t1, Tsph+273, 'og', mec='g', label='axis')
...
py.figure(2)
py.plot(t, Ys, '-b', label='model')
py.plot(t2, Msph, 'og', mec='g', label='expmt.')
py.ylim([0, 1.1])
py.legend(loc='best', numpoints=1)
py.xlabel('Time (s)')
